...
const TRANSLATIONS = { en, 'es-419': es419, ja, 'pt-BR': ptBR, 'fr-FR': frFR, 'de-DE': deDE, 'it-IT': itIT, 'tr-TR': trTR };
 ...
 */
const SCREEN_LANGS = new Set(['en', 'es-419', 'ja', 'pt-BR', 'fr-FR', 'de-DE', 'it-IT', 'tr-TR']);
